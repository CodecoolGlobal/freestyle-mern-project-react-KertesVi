...
export default function AdoptedCats() {
  return (
    ...
    <div className="container">
      ...
      <div className="card">
        <img src="https://www.comfortzone.com/-/media/Project/OneWeb/ComfortZone/Images/Blog/adopting-an-older-cat.jpg" alt="Hug Cat" />
      ...
      <div className="card">
        <img src="https://d.newsweek.com/en/full/2221075/bonded-cats-melt-hearts-online.png?w=1600&h=1200&q=88&f=b0de66ddd8207f53d35bcebee1d87a45" alt="Brothers" />
